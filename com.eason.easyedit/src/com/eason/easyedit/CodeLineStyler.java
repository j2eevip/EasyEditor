...
class CodeLineStyler implements LineStyleListener {
	...
	private void initializeColors() {
		...
		colors = new Color[] { new Color(display, new RGB(0, 0, 0)), // black
				...
				new Color(display, new RGB(251, 171, 225))};//PINK
	...
	public void lineGetStyle(LineStyleEvent event) {
		...
		while (token != Constant.EOF) {
			if (token != Constant.WHITE || token == Constant.COMMENT) {
	...
	private void makeLineNumber(LineStyleEvent event, StyledText text) {
